...
/**
 * A {@link FluentPage} used to facilitate the testing of the TextEx application's search / browse
 * books page.
 * 
...
public class SearchPage extends FluentPage {
  ...
  /**
   * Tests that the search function is able to retrieve the added books. Must be called after the
   * {@link AddPage} tests.
   */
  public void testSearch() {
    click("#searchSubmit");
    assertTrue("Should have 2 Books.", this.pageSource().contains("222-222-2222")
        && this.pageSource().contains("111-111-1111"));

    fill("#title").with("My");
    click("#searchSubmit");
    assertTrue("Should have 1 Books.", !this.pageSource().contains("222-222-2222")
        && this.pageSource().contains("111-111-1111"));
